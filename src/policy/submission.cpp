 ...
 * @return Move 
 */
Move Submission::get_move(State *state, int depth, int player){
...
int Submission::alphabeta_caculate(State *state, int depth, int alpha, int beta, bool maxiPlayer, int player)
{

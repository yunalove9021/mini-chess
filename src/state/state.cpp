...
int State::evaluate(int player_)
{
  // [TODO] design your own evaluation function
  const int the_value[7] = {0, 2, 6, 7, 8, 20, 100000}; // (0, ♟Pawn, ♜Rook, ♞Knight, ♝Bishop, ♛Queen, ♚King)
  int total = 0;
  ...
  //total -= the_value[this->board.board[!(1&this->player)][i][j]] * board.value[this->board.board[!(1&this->player)][i][j]][i][j];
}
